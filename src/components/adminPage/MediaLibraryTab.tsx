...
import PhotoEditDialog, { type Photo } from '@/components/dialogs/PhotoEditDialog';
        ...
        <header className="flex flex-col gap-4 mb-6 md:mb-8">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-4">
            ...
            <button
                ...
                className="hidden md:flex items-center gap-2 px-6 py-3 bg-savanna-gold text-savanna-charcoal text-sm font-medium tracking-wide hover:bg-savanna-gold/90 transition-all active:scale-95 rounded-md"
            >
