...
import ServiceEditDialog, { type Service } from '@/components/dialogs/ServiceEditDialog';
        ...
        <div className="flex flex-col gap-4 mb-6 md:mb-12">
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 md:gap-6">
            ...
            <button
                ...
                className="hidden md:flex bg-savanna-gold text-savanna-charcoal px-8 py-4 text-sm tracking-wide font-medium items-center gap-3 transition-transform active:scale-95 shadow-lg shadow-savanna-gold/10 hover:bg-savanna-gold/90 rounded-md"
            >
          ...
          <div className="flex items-center gap-2 overflow-x-auto pb-2 hide-scrollbar w-full">
            {filters.map((filter) => (
                <button
                    ...
                    className={`px-4 md:px-6 py-2 whitespace-nowrap text-xs md:text-sm font-medium transition-colors flex-shrink-0 ${
                        activeFilter === filter
